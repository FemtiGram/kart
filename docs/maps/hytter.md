...
3-tier search: Fylke (3 results), Kommune (5 results), Adresse (2 results). 300ms debounce. Abort controller. "Min posisjon" with `isInNorway()` fallback to Jotunheimen.
