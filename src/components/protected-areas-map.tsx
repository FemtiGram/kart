...
import { Map as MapIcon, ChevronUp, Info, ExternalLink, ArrowRight } from "lucide-react";
        ...
        <div className="max-w-xl mx-auto relative flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between">
            <p className="text-xs text-foreground/70">
              {loading
                ? "Henter verneområdedata..."
                : `${loadedCount} kommuner · Vernet areal · Kilde: SSB tabell 08936 · 2024`}
            </p>
            <button
