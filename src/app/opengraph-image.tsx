...
export const alt = "Datakart — Utforsk Norge gjennom åpne geodata";
    ...
    (
      ...
      >
        ...
        <p style={{ fontSize: 28, color: "rgba(255,255,255,0.7)", marginTop: 16 }}>
          Interaktive kart og dashboards bygd på offentlige data fra SSB, NVE, Kartverket og flere
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          {["Energi", "Natur", "Samfunn", "357 kommuner"].map((label) => (
            <div
              key={label}
              style={{
                padding: "10px 24px",
