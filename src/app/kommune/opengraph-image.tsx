...
export const alt = "Kommuner i Norge — Datakart";
    ...
    (
      ...
      >
        ...
        <p style={{ fontSize: 28, color: "rgba(255,255,255,0.7)", marginTop: 16 }}>
          Stedsprofil for alle 357 kommuner — befolkning, boligpriser, energi, skoler
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          {["Befolkning", "Inntekt", "Bolig", "Energi", "Skoler"].map((label) => (
            <div
              key={label}
              style={{
                padding: "10px 24px",
