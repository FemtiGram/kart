...
export const alt = "Magasinkart — Datakart";
    ...
    (
      ...
      >
        ...
        <p style={{ fontSize: 28, color: "rgba(255,255,255,0.7)", marginTop: 16 }}>
          Regulerte vannmagasiner i Norge med fyllingsgrad og polygon-visning
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          {["Fyllingsgrad", "Magasiner", "Vannkraft", "NVE"].map((label) => (
            <div
              key={label}
              style={{
                padding: "10px 24px",
