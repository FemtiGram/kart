...
export const alt = "Ladestasjoner — Datakart";
    ...
    (
      ...
      >
        ...
        <p style={{ fontSize: 28, color: "rgba(255,255,255,0.7)", marginTop: 16 }}>
          Alle elbilladestasjoner i Norge på kart — kontakttyper, kapasitet og tilgjengelighet
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          {["Sanntidsdata", "Kontakttyper", "Kapasitet", "Nobil API"].map((label) => (
            <div
              key={label}
              style={{
                padding: "10px 24px",
